...
//        return a + (2 * i - 1) * (b - a) /(2 * n);
    ...
    public static void main(String[] args) {
        int[]nums=new int[]{87,77,92,68,80,78,84,77,81,80,80,77,92,86, 76,80,81,75,77,72,81,72,84,86,80,68,77,87, 76,77,78,92,75,80,78};
        System.out.println(nums.length);
        Double[] list=new Double[nums.length];
        for(int i=0;i<nums.length;i++){
            list[i]=Double.valueOf(nums[i]);
        }
        //3	2	5	3	2	2	6	2	2	8	6	6	4	2	2	2	6	8	1	7	2	5	2	5	2	2	1	2	100
